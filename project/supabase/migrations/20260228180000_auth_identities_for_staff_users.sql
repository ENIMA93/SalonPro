-- Add instance_id, aud to auth.users and insert auth.identities so staff users can sign in

-- 1. handle_new_staff_user: auth.users + auth.identities
...
-- 2. create_staff_user_account: auth.users + auth.identities
...
-- 3. create_staff_with_login: auth.users + auth.identities
